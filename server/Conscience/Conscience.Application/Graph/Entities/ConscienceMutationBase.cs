...
namespace Conscience.Application.Graph.Entities
{
    ...
    {
        protected void ModifyCollection<T, R>(BaseRepository<R> repository, LogEntryService logService, ICollection<T> collection, ICollection<T> dbCollection, Action<T, T> setProperties, Func<T, T, bool> additionalPredicate = null, bool shouldRemove = true)
